...
- [x] L'écran d'aide s'affiche automatiquement lors de la toute première partie jouée, puis reste accessible à la demande ensuite via un bouton. Réparti sur 2 pages (bouton précédent/suivant + indicateur "1/2") plutôt qu'un seul écran chargé : la première regroupe les explications de contrôle (déplacement, tir, NOVA, boss, musique), la seconde la légende visuelle bonus/ennemis.
