...
- [x] Les scénarios réseau (fin de piste, 429) sont testés avec de la **latence simulée** : le serveur local répond en quelques ms et masque les bugs de timing (voir *Retour d'expérience*, sixième round).
